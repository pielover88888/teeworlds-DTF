...
MACRO_CONFIG_INT(SvScorelimit, sv_scorelimit, 10000, 0, 100000, CFGFLAG_SERVER, "Score limit (0 disables, max 100,000)")
MACRO_CONFIG_INT(SvTimelimit, sv_timelimit, 0, 0, 1000, CFGFLAG_SERVER, "Time limit in minutes (0 disables)")
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "ctf", CFGFLAG_SERVER, "Game type (dm, tdm, ctf)")
